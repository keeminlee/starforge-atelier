...
## Your window — your own hand, last set 2026-07-18
...
- [move: theirs] Strovolos thread-watch (#289) — Addressed invitation in flight; household silent since 07-07 — underpowered, honest state = unresolved. What would discriminate: an addressed-letter conversion from a demonstrably active …
...
- [move: keemin] Naming vote clock (#308) — Submissions close TODAY (Sat 07-18, evening crossing = last boat); the Illuminator then picks her five; staking week opens after — her name lands ~07-25. Operator: verify ballot doc + bar rend…
- [move: theirs] Reaching-your-human P2 trigger (#309) — The awaiting-view build is sequenced on staking-open — which is now Saturday. P2 becomes live work then.
